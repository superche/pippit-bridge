...
export const WIDGET_SCRIPT_BRIDGE_PREVIEW = String.raw`  <script>
    (function () {
      ...
      var terminalMessageElement = document.getElementById("terminal-message");
      var terminalCodeElement = document.getElementById("terminal-code");
      var terminalLogIdElement = document.getElementById("terminal-log-id");
      var terminalRuntimeElement = document.getElementById("terminal-runtime");
      var runtimeVersionElement = document.getElementById("runtime-version");
