...
`pippit/seedream-5.0` 必须完全省略 `resolution`；`pippit/seedream-5.0-pro` 可省略或使用 `1K`、`2K`、`4K`。`input_references` 最多 9 张，图片完成后以 OpenRouter dedicated Image API 的 `data[].b64_json` 同步返回。
