...
- `scripts/plugin-contract.mjs`：从真实 launcher 做 initialize、tools/resources/templates list 和逐 URI read；合并 manifest、`.mcp.json`、Skill digest 和人工 result semantics，使用 format-v1 canonical JSON 和 SHA-256。
